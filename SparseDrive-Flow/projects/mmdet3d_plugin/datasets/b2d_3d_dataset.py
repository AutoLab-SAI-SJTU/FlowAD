...
class B2D3DDataset(Dataset):
    ...
    def __init__(
        ...
        self.map_element_class = {'Broken':0, 'Solid':1, 'SolidSolid':2,
    ...
    def get_map_info(self, index):
        ...
        map_anno = {one: [] for one in self.map_element_class.values()}
        for idx in chosed_idx:
            ...
            if len(points_in_ego_range) > 1:
                map_anno[self.map_element_class[lane_types[idx]]].append(points_in_ego_range)
    ...
    def get_data_info(self, index):
        ...
        #     2: info["map_annos"][2],
        # }
        map_annos = self.get_map_info(index)
        ...
        input_dict['ego_pose'] = copy.deepcopy(input_dict['ego_status'])
    ...
    def evaluate(
        ...
        if eval_mode['with_planning']:
            from .evaluation.planning.planning_eval_b2d import planning_eval
