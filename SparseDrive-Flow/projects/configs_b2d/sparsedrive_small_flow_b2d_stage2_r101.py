...
version = 'mini'
version = 'trainval'
length = {'trainval': 23476, 'mini': 323}
...
train_pipeline = [
    ...
    dict(
        type="DenseDepthMapGenerator", # MultiScaleDepthMapGenerator
...
load_from = './SparseDrive/ckpts/iter_17580_flow_r101_s2.pth'
# load_from="./SparseDrive/work_dirs/iter_10975_flow_r50_s2.pth" ##
