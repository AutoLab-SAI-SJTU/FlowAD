...
load_from = './'
# load_from = '/data3/guomingzhe/SparseDrive/work_dirs/sparsedrive_small_stage2_flow_attn_wm_mlfuse_ego_pe_spatial--/iter_10000.pth'
load_from = './SparseDrive/pretrain/cascade_mask_rcnn_r101_fpn_1x_nuimage_drive.pth'
