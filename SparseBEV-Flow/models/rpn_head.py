...
class RPNHead_local(AnchorHead):
    """RPN head.
    ...
    def __init__(self,
        ...
        super(RPNHead_local, self).__init__(
    ...
    def loss(self,
        ...
        """
        losses = super(RPNHead_local, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def _get_bboxes_single(self,
        ...
        img_shape = img_meta['img_shape'] if len(img_meta['img_shape']) < 4 else img_meta['img_shape'][0]
    ...
    def onnx_export(self, x, img_metas):
        ...
        batch_bboxes, batch_scores = super(RPNHead_local, self).onnx_export(
