...
class NMSFreeCoder_Track(BaseBBoxCoder):
    ...
    def decode_single(self, cls_scores, bbox_preds, sample_feats):
        """Decode bboxes.
        Args:
        ...
        if self.private:
            cls_scores = cls_scores[..., self.indexes]
        ...
        final_scores = scores 
        final_preds = labels 
        final_sample_feats = sample_feats
        ...
        if self.post_center_range is not None:
            ...
            sample_feats = final_sample_feats[mask]
            predictions_dict = {
                'bboxes': boxes3d,
                'scores': scores,
                'labels': labels,
    ...
    def decode(self, preds_dicts):
        ...
        for i in range(batch_size):
            predictions_list.append(self.decode_single(all_cls_scores[i], all_bbox_preds[i], all_sample_feats[i]))
