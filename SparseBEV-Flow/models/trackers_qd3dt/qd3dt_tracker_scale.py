...
class MOTModel(torch.nn.Module):
    def __init__(self, configs):
        ...
        self.match_score_thr = [0.5, 0.3]  # [0.3, 0.5]  # 0.5
        ...
        self.buffer_bbox = True  # attn!!!
        self.with_scales = [False, True]
        self.multi_scale_matching = [False, True]  # including self.with_scales
        self.re_matching = True  # if re-match after self.multi_scale_matching
    ...
    def frame_mot(self, origin_data, timestamp=None):
        ...
        img_feats = raw_data['query_feats']
        bev_feats = raw_data['query_feats']
