...
class SparseBEVHead_flow_attn_wm(DETRHead):
    def __init__(self,
                 *args,
                 num_classes,
                 in_channels,
        ...
        super(SparseBEVHead_flow_attn_wm, self).__init__(num_classes, in_channels, train_cfg=train_cfg, test_cfg=test_cfg, **kwargs)
        ...
        for idx, mlvl_feat in enumerate(mlvl_feats):
            ...
            if self.flow_wm_ids:
                ...
                if idx in self.flow_wm_ids:
                    ...
                    output_wm, mlvl_feat_flow_unfold_fut = self.world_models[layer_idx](rearrange(mlvl_feat_flow_unfold.mean(dim=2), 'b c y p -> b p y c').mean(dim=1, keepdim=True), action_query)
                    ...
                    mlvl_feat_flow_unfold_fuse = self.flow_wm_mlps[layer_idx](rearrange(mlvl_feat_flow_unfold, 'b c h y p -> b h y p c')+mlvl_feat_flow_unfold_fut.reshape(B*TN, 1, W//flow_patch, 1, C))
