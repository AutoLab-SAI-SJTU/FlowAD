...
class SparseBEVHead_flow_attn_wm_mlfuse_temporal(DETRHead):
    def __init__(self,
                 *args,
                 num_classes,
                 in_channels,
        ...
        super(SparseBEVHead_flow_attn_wm_mlfuse_temporal, self).__init__(num_classes, in_channels, train_cfg=train_cfg, test_cfg=test_cfg, **kwargs)
        ...
        self.flow_tem_attns = nn.ModuleList([
            FlowAttention(dim=in_channels, heads = 4, dim_head = in_channels//4, dropout = 0., with_res=True) for flow_attn_tem_id in self.flow_attn_tem_ids
        ])
