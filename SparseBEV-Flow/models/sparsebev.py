...
class SparseBEV(MVXTwoStageDetector):
    ...
    #     """
    #     if return_loss:
    #         return self.forward_train(img=img, img_metas=img_metas, gt_bboxes_3d=gt_bboxes_3d, gt_labels_3d=gt_labels_3d, **kwargs)
    #     else:
    #         if img is None and img_metas is not None:
    #             self.img_metas = img_metas
    #             return
    #         img_metas = self.img_metas if img_metas is None else img_metas
