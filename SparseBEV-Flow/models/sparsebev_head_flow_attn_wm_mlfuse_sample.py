...
class SparseBEVHead_flow_attn_wm_mlfuse_sample(DETRHead):
    def __init__(self,
                 *args,
                 num_classes,
                 in_channels,
        ...
        super(SparseBEVHead_flow_attn_wm_mlfuse_sample, self).__init__(num_classes, in_channels, train_cfg=train_cfg, test_cfg=test_cfg, **kwargs)
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        patch_query = self.patch_crossattn(patch_query.flatten(1,2).unsqueeze(1), mlvl_feats_flow_unfold_fuse).reshape(B, T, 6, W//flow_patch, C)
