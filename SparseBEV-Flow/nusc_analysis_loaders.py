    ...
    for sample_token in tqdm.tqdm(sample_tokens, leave=verbose):
        ...
        for sample_annotation_token in sample_annotation_tokens:
            ...
            if box_cls == DetectionBox:
                ...
                box_tmp.token = sample_annotation['token']
                box_tmp.vis_level = int(nusc.get('visibility', nusc.get('sample_annotation', sample_annotation['token'])['visibility_token'])['token'])
                sample_boxes.append(
                    box_tmp
                )
