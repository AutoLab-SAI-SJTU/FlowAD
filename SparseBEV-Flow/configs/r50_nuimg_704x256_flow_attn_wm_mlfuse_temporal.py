...
model = dict(
    ...
    img_neck=img_neck,
    pts_bbox_head=dict(
        type='SparseBEVHead_flow_attn_wm_mlfuse_temporal',
        flow_patches=flow_patches,
        flow_ids=flow_ids,
        flow_attn_ids=flow_attn_ids,
        flow_attn_tem_ids=flow_attn_tem_ids,
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Collect3D', keys=['img'], meta_keys=(
                ...
                'lidar2img', 'img_timestamp', 'sample_idx'))
        ])
]
...
data = dict(
    ...
    train=dict(
        ...
        ann_file=info_root + 'nuscenes_infos_train_sweep_cycer.pkl',
    ...
    val=dict(
        type=dataset_type,
        data_root=dataset_root,
        ann_file=info_root + 'nuscenes_infos_val_sweep_cycer.pkl',
