dataset_type = 'NuSceneOccEgoTraj'
...
train_pipeline = [
    ...
    dict(type='LoadMultiViewImageFromMultiSweepsEgoTraj', sweeps_num=_num_frames_ - 1),
...
test_pipeline = [
    dict(type='LoadMultiViewImageFromFiles', to_float32=False, color_type='color'),
    dict(type='LoadMultiViewImageFromMultiSweepsEgoTraj', sweeps_num=_num_frames_ - 1, test_mode=True),
...
load_from = 'ckpts/sparseocc_r50_nuimg_704x256_8f_60e_v1.1.pth'
